...
print("With a starting point of: {start_point}".format(start_point=start_point))
print("We'd have {b} jelly beans, {j} jars, and {c} crates.".format(b=beans, j=jars, c=crates))
